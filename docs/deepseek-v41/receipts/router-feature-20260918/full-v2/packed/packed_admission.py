...
def resolve_admission(base, wired, *, grow, expected_receipt_hash, strict_allocator):
    ...
    spec = importlib.util.spec_from_file_location('native_growth_admission', '/tmp/dsv41-router-feature-20260918/full-v2/native/admission.py')
    ...
    diagnostic_host = 384 * 1024**2
    diagnostic_active = 64 * 1024**2
    ...
    for capacity in range(105, old_capacity, -1):
    ...
    result.update(
        ...
        capacity_selection='largest admitted packed capacity above prefill through105; explicit384MiB diagnostic host and64MiB Metal allowances',
