...
ROOT = Path('/private/tmp/dsv41-predictable-expansion-20260919/full-v1/native')
...
def resolve_admission(base, wired, *, grow, expected_receipt_hash):
    ...
    return dict(physical_ceiling_bytes=DEFAULT_BOX_BUDGET_BYTES, prefill_slots_per_layer=initial, decode_slots_per_layer=capacity,
        ...
        prefill_cache_allowance_bytes=prefill_cache, host_reserve_bytes=host_reserve, projection_host_allowance_bytes=16 * 1024**2, tail_host_allowance_bytes=16 * 1024**2, engram_bytes_per_bank=67108864,
