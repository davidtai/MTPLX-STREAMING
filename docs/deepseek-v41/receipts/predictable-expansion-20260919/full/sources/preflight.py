...
assert a['decode_slots_per_layer']==111 and a['initial_decode_slots_per_layer']==110 and a['physical_bound_bytes']<=110000000000
...
(r/'expansion-admission.json').write_text(json.dumps(result,indent=2)+'\n')
