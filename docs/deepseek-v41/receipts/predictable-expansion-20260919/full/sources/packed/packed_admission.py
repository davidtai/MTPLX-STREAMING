...
def resolve_admission(base, wired, *, grow, expected_receipt_hash, strict_allocator):
    ...
    spec = importlib.util.spec_from_file_location('native_growth_admission', '/private/tmp/dsv41-predictable-expansion-20260919/full-v1/native/admission.py')
