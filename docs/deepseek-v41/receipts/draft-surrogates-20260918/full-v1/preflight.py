...
assert a['decode_slots_per_layer']==111 and a['physical_bound_bytes']<=110000000000
assert a['embedding_host_allowance_bytes']==32*1024**2 and a['lookup_host_allowance_bytes']==16*1024**2
assert a['draft_resident_payload_credit_bytes']==733224960 and a['draft_prefill_bound_credit_bytes']==0
...
(r/'draft-admission.json').write_text(json.dumps(result,indent=2)+'\n')
