"""Inspect/reclaim clean cached pages of this exact DeepSeek artifact, no MLX.
...
def main():
    ...
    paths = [ROOT / 'experts.bin', *sorted(ROOT.glob('model-*.safetensors')),
             ROOT / 'engram/engram-L1.bin', ROOT / 'engram/engram-L14.bin',
             ROOT / 'engram/engram-residents.safetensors']
