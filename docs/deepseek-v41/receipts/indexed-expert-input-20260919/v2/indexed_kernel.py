...
def make_indexed_projection(n, k):
    if (n, k) != (2304, 5120):
...
'''
    return mx.fast.metal_kernel(
        name=f'dsv41_packed_scales_{n}_{k}_indexed_input',
        input_names=['x', 'pairs', 'token_rows', 'weights', 'row_desc', 'scale_payload', 'expert_offsets'],
