...
OUT=Path('/private/tmp/dsv41-hybrid-lookup-20260918/head-screen.json')
...
CURRENT_ROOT=Path('/private/tmp/dsv41-hybrid-lookup-20260918')
...
for mode in ('native','hybrid_m8'):
    ...
    print('HYBRID_HEAD_ARM',json.dumps({k:row[k] for k in ('mode','cycles','verify_rows','verify_width_counts','head_replay_wall_s','mlx_peak_bytes')}),flush=True)
