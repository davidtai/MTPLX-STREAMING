...
OUT=ROOT/'cpu-scatter-results.json'
if OUT.exists():
...
if len(layers)!=40 or len(records)!=5120:
...
batches=tuple(tuple(records[layers[i%40],(i*11+offset)%128] for offset in (0,37,79)) for i in range(512))
