...
OUT=Path('/private/tmp/dsv41-q2-draft-20260918/dense/head-screen.json')
...
CURRENT_ROOT=Path('/private/tmp/dsv41-q2-draft-20260918/dense')
...
class DraftOnly(nn.Module):
    def __init__(self,width,compact,expert_bits=4,dense_q2=False):
        ...
        base_predicate = dv._make_mtp_dense_quant_predicate(32)
...
for mode in ('hybrid_control_cold', 'q2_experts_cold', 'mixed_q2_cold', 'hybrid_control_warm', 'q2_experts_warm', 'mixed_q2_warm', 'hybrid_control_final'):
    ...
    gc.collect();mx.synchronize();mx.clear_cache()
for prefix in ('q2_experts', 'mixed_q2'):
