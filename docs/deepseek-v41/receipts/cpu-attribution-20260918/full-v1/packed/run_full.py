...
PACKED_ROOT = Path('/private/tmp/dsv41-cpu-attribution-20260918/full-v1/packed')
...
GROWTH_ROOT = Path('/private/tmp/dsv41-cpu-attribution-20260918/full-v1/compat')
...
try:
    ...
    from clock_probe import Recorder
