...
assert a['decode_slots_per_layer']==109 and a['physical_bound_bytes']<=110000000000
assert a['diagnostic_host_allowance_bytes']==16*1024**2
assert a['diagnostic_active_allowance_bytes']==0
