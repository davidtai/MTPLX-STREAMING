"""Exact full workload for the direct packed-MXFP8 target ``wo_a`` route."""
import hashlib
...
signal.alarm(1200)
PREFIX = Path('/tmp/dsv41-110-preflight/python-16k-1024-woa-direct')
...
bounds = {
    ...
    'scope': 'exact native artifact,16K prompt,1023 steps,depth5,pf0,direct packed MXFP8 target wo_a,compiled draft,bf16 heads; 8.5GiB planning band,2GiB cache,2GiB Python',
}
