...
OUT=Path('/private/tmp/dsv41-draft-conditioned-tail-20260918/trajectory/head-screen.json')
...
CURRENT_ROOT=Path('/private/tmp/dsv41-draft-conditioned-tail-20260918/trajectory')
