...
def _clamped_activation_body(gate, up):
    return _clamped_swiglu(gate, up, 10.0)


_clamped_activation = mx.compile(_clamped_activation_body, shapeless=True)
