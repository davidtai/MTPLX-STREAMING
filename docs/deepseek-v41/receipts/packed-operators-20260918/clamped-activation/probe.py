...
def run_arm(mode, sequence):
    ...
    try:
        ...
        lane = plane_lane if mode=='native' else plane_lane_activation
...
try:
    ...
    candidates=[a['warm_total_ns'] for a in report['arms'] if a['mode']=='activation']
