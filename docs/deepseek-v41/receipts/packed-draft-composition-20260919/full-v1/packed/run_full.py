...
PACKED_ROOT = Path('/private/tmp/dsv41-packed-draft-full-20260919/full-v1/packed')
...
GROWTH_ROOT = Path('/private/tmp/dsv41-packed-draft-full-20260919/full-v1/compat')
...
try:
    ...
    def observe_seed_prefill(*a, **kw):
        ...
        growth_report.update(first_packed_growth=first_growth, overflow=overflow_report,
            ...
            timing_scope='Scale installation at84 rows, native MTP seed, early projection priming and separate extension allocation are inside decode wall time; growth_seconds sums scale and extension phases only.')
        return result
