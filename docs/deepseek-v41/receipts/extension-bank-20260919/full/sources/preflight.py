...
assert a['decode_slots_per_layer']==112 and a['initial_decode_slots_per_layer']==84 and a['physical_bound_bytes']<=110000000000
...
(r/'extension-admission.json').write_text(json.dumps(result,indent=2)+'\n')
