...
def resolve_admission(base, wired, *, grow, expected_receipt_hash, strict_allocator):
    ...
    spec = importlib.util.spec_from_file_location('native_growth_admission', '/private/tmp/dsv41-embedding-rows-20260918/full-v1/native/admission.py')
    ...
    for capacity in range(strict['capacity_search_ceiling'], old_capacity, -1):
        ...
        physical = base + original['host_reserve_bytes'] + embedding_host + active + original['decode_cache_allowance_bytes']
