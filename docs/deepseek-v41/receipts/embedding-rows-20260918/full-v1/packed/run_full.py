...
PACKED_ROOT = Path('/private/tmp/dsv41-embedding-rows-20260918/full-v1/packed')
...
GROWTH_ROOT = Path('/private/tmp/dsv41-embedding-rows-20260918/full-v1/compat')
...
try:
    ...
    _cleanup = [_cleanup_module.reclaim_file(_source_path),
                _cleanup_module.reclaim_file(PACKED_INSTALLATION['embedding_optimization']['source']['path'])]
