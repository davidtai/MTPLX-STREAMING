...
def resolve_admission(base, wired, *, grow, expected_receipt_hash):
    ...
    spec = importlib.util.spec_from_file_location('native_growth_admission', '/tmp/dsv41-cache-budget-20260918/full-v1/native/admission.py')
