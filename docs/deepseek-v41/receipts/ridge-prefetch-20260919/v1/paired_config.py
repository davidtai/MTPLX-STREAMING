"""Explicit configuration type for this bounded three-layer experiment only.
...
its three-layer spec, shared16-slot ring and source-pinned bank implementation
...
class PairedPrefetchConfig(ExpertStreamingConfig):
    def __post_init__(self):
        if (self.model_key!='deepseek-v41-flash-expert-mxfp4'
                ...
                or self.memory_limit_bytes!=10*1024**3
                or self.expert_cache_limit_bytes!=315*18800640):
