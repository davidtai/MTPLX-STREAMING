...
def resolve_admission(base, wired, *, grow, expected_receipt_hash):
    ...
    spec = importlib.util.spec_from_file_location('native_growth_admission', '/tmp/dsv41-plane-overlap-20260917/full/native/admission.py')
    ...
    result.update(
        ...
        bound_scope='proved cap84 prefill and native M6/M8 envelope, exact packed storage plus copy allowance and 64MiB for early plane intermediates',
    )
    return result
