...
PACKED_ROOT = Path('/tmp/dsv41-miss-part1-full-20260918/packed')
...
GROWTH_ROOT = Path('/tmp/dsv41-miss-part1-full-20260918/compat')
...
if decode_steps != 1023 or cache_policy != 'transition-window' or miss_records_per_part != 1 or not shared_overlap:
