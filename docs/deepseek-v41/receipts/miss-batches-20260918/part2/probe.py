...
def run_arm(part_size, sequence):
    ...
    try:
        ...
        lane = plane_lane if part_size==3 else plane_lane_part2
...
try:
    ...
    controls=[a['warm_total_ns'] for a in report['arms'] if a['part_size']==3]
    candidates=[a['warm_total_ns'] for a in report['arms'] if a['part_size']==2]
