...
files = [Path(installation['model_path']) / 'model-00003.safetensors']
...
try:
    ...
    print('PROJECTION_SOURCE_CACHE_RECLAIMED', json.dumps({k:v for k,v in report.items() if k != 'files'}), flush=True)
