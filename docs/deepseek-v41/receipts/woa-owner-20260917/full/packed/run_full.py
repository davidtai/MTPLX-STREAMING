...
PACKED_ROOT = Path('/tmp/dsv41-woa-owner-20260917/full/packed')
...
GROWTH_ROOT = Path('/tmp/dsv41-woa-owner-20260917/full/compat')
...
try:
    ...
    def checked_load(*a, **kw):
        global growth_transition, growth_report, prefill_resolved_plan, projection_owner_report
        ...
        def grow_and_install_projection_owners():
            native_growth()
            projection_owner_report.update(install_model(target_ref()))
