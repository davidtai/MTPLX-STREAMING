...
assert a['embedding_host_allowance_bytes']==32*1024**2 and a['lookup_host_allowance_bytes']==48*1024**2
...
(r/'consensus-admission.json').write_text(json.dumps(result,indent=2)+'\n')
