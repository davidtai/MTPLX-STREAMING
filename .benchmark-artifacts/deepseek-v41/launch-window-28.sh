...
echo '[step 4] 16K prefill_lean_sel at 72 GiB plan (decode 32)'; \$PY scripts/deepseek_v41/ab_decode_env_levers.py --context-tokens 16384 --decode-tokens 32 --max-kv 16640 --arms prefill_lean_sel --memory-limit-gib 72 --out $OUT/prefill-16384-sel-72g.json 2>&1 | grep -vE \"\$F\" | tail -6
